...
VALUES 					(N'Câu hỏi về Java '	,	1		,   '1'			,   '2'		,'2020-04-05'),
						(N'Câu Hỏi về PHP6'	,	10		,   '2'			,   '2'			,'2020-02-05'),
						(N'Hỏi về C#5'		,	9		,   '2'			,   '3'			,'2020-04-06'),
						(N'Hỏi về Ruby4'		,	6		,   '1'			,   '4'		,'2020-06-06'),
						(N'Hỏi về Postman3'	,	5		,   '1'			,   '5'			,'2019-04-06'),
						(N'Hỏi về ADO.NET'	,	3		,   '2'			,   '6'			,'2020-04-06'),
						(N'Hỏi về ASP.NET'	,	2		,   '1'			,   '7'			,'2018-07-06'),
						(N'Hỏi về C++96'		,	8		,   '1'			,   '8'		,'2020-08-07'),
						(N'Hỏi về SQL91'		,	4		,   '2'			,   '9'		,'2020-08-07'),
						(N'Hỏi về Python71'	,	7		,   '1'			,   '10'		,'2019-01-07'),
                        (N'Hỏi về DO.NET82'	,	3		,   '2'			,   '6'			,'2020-11-06'),
						(N'Hỏi về P.NET'	,	2		,   '1'			,   '7'			,'2020-10-06'),
						(N'Hỏi về C+0'		,	8		,   '1'			,   '8'			,'2010-12-07'),
						(N'Hỏi về SQLM89'		,	4		,   '2'			,   '9'		,'2020-2-07'),
						(N'Hỏi về Pythonhg78'	,	7		,   '1'			,   '10'	,'2010-1-07');
