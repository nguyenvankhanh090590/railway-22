...
VALUES					(	'1'		,	'1'	,	N'KhanhVTi@gmail.com','KN_1',N'Nguyễn Văn Khánh','5','2021-10-10'),
						(	'2'		,	'1'	,	N'DangtheVIT@gamil.com','DTV_1',N'Đặng Thế Vinh','4','2021-10-10'),
                        (	'3'		,	'0'	,	N'Hoangthu@mail.com','HTT_1',N'Hoàng Thị Thu','3','2021-10-10'),
                        (	'4'		,	'0' ,	N'Hienvinh@gmail.com','Hien_1',N'Nguyễn Thu Hiền','2','2021-10-10'),
                        (	'5'		,	'1'	,	N'Hoangkimdat@mgail.com','DAT09',N'Hoàng Kim Đạt','1','2021-10-10');
...
VALUES				 	(		'1'		,N'VARCHAR la constraints','5'	  ,'1'		,'2021-10-10'),
						(		'2'		,N'ENUM sử dụng chuỗi kí tự biến đổi dạng tring','4','1','2021-10-10'),
                        (		'3'		,N'DECIMAL là datatype nhập số theo mẫu đặt ra','3','1','2021-10-10'),
                        (		'4'		,N'PRIMARY KEY là khoá phụ ','2','1','2021-10-10'),
                        (		'5'		,N'PRIMARY KEY là khoá chính của trường','1','1','2021-10-10');
